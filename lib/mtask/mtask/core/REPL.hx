...
/**
	A run/evaluate/print loop for mtask.

	Invoking mtask with no arguments enters into REPL mode, which allows users 
	to work with tasks directly and query build properties.
**/
class REPL
{
	var position:Int = -1;
