...
flickrapp.flickr.view.GalleryView = function() {
	...
	this.set_stroke(new mui.display.Color(15263976));
	this.set_strokeThickness(2);
	var gridLayout = new mui.layout.GridLayout();
	gridLayout.set_cellWidth(200);
	gridLayout.set_cellHeight(150);
	gridLayout.wrapIndex = 5;
	this.set_layout(this.set_layout(gridLayout));
	this.layout.enabled = true;
...
flickrapp.flickr.view.SearchBoxView.prototype = $extend(mui.core.DataContainer.prototype,{
	...
	,onSubmit: function() {
		...
		this.clickSignal.dispatch("do search",keywords);
	}
...
flickrapp.flickr.view.SearchBoxViewMediator.prototype = $extend(mmvc.impl.Mediator.prototype,{
	loadFlickrData: null
	,onRegister: function() {
		haxe.Log.trace("----first register -------",{ fileName : "SearchBoxViewMediator.hx", lineNumber : 19, className : "flickrapp.flickr.view.SearchBoxViewMediator", methodName : "onRegister"});
		mmvc.impl.Mediator.prototype.onRegister.call(this);
	...
	,searchHandler: function(event,searchTerm) {
		if(event == "do search") {
			haxe.Log.trace("start to dispatch the loadFlickrData signal -" + searchTerm,{ fileName : "SearchBoxViewMediator.hx", lineNumber : 36, className : "flickrapp.flickr.view.SearchBoxViewMediator", methodName : "searchHandler"});
			this.loadFlickrData.dispatch(searchTerm,10);
		}
	}
...
flickrapp.flickr.view.TitleButton = function() {
	mui.control.DataButton.call(this);
	this.set_fill(new mui.display.Color(16777215));
...
haxe.Resource.content = [{ name : "params", data : "eyJ3aWR0aCI6MCwidmVyc2lvbiI6IjAuMS4wIiwiYXBwIjoicHJvamVjdC1pZC0wLjEuMCIsImhlaWdodCI6MCwidGFyZ2V0Ijoia2V5IiwidGl0bGUiOiJOZXdGbGlja3JfTVVJIiwiYmFzZVVybCI6IiIsImJ1aWxkIjoiZGVmYXVsdC51c2VyIDIwMTQtMDctMTQgMTU6MDc6MjYifQ"}];
...
flickrapp.flickr.view.SearchBoxViewMediator.__meta__ = { fields : { loadFlickrData : { name : ["loadFlickrData"], type : ["flickrapp.flickr.signal.LoadFlickrData"], inject : null}}};
